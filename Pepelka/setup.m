...
% Set home folder
fprintf('Setting home folder in "core/pplk_homeDir.m" to %s ... ',pwd());
...
answ = input('Add "Pepelka/core" folder to the Matlab path? ([y]/n) > ','s');
% Add to path
...
% Compile
answ = input('Compile MEX files required by some methods? (You should set-up a compiler before.) ([y]/n) > ','s');
if isempty(answ) || lower(answ)=='y' || strcmpi(answ,'yes')
...
fprintf('Please, report bugs to nejc.ilc@fri.uni-lj.si. Thanks!\n');

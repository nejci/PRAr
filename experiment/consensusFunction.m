        ...
        for data_i = 1:datasets_num
            ...
            for r_i = 1:R
                ...
                if isPRAEnabled
                    ...
                    CONS_params.WEAC_CVImat = CVImat_sel;
                end
                ...
                for c_i = 1:C   
                    ...
                    if isPRAEnabled
                        ...
                        CONS_params.WEAC_CVI = WEAC_CVI;
                        CONS_params.WEAC_unifyMeth = conf_vec{1};
                        CONS_params.WEAC_reduceMeth = conf_vec{2};
                        CONS_params.WEAC_reduceDim = conf_vec{3};
                        CONS_params.WEAC_weightMeth = conf_vec{4};
                        CONS_params.WEAC_weightMode = conf_vec{5};
                    end
                    % Compute consensus partition                    
                    ticID = tic();
                    CP(:,r_i,c_i) = pplk_consEns(labelsENS, K, consFun, CONS_params);
